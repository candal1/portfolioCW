<template>
    <div class="bg-orange-100 flex justify-center py-32">
        <div class="md:flex items-center justify-center gap-20 bg-blue-800 px-10 py-10 rounded-lg shadow-2xl text-orange-100">
            <div class="flex flex-col items-center max-w-sm gap-5">
                <img class="flex-shrink max-w-xs rounded shadow-lg" src="../assets/Album_Cover.jpg" alt="5 Years of Winter album cover">
