<template>
    <div class="bg-orange-100 flex flex-col items-center">
        <div class="grid py-20 items-center max-w-xl">
           ...
           <h2  class="font-bold text-3xl uppercase pt-3 text-center trackng-tighter">Internship</h2>
           <h2  class="italic text-2xl pb-2">Mix Factory One Studio</h2>
           ...
           <h2  class="font-bold text-3xl uppercase pt-3 text-center tracking-tighter">RF Crew</h2>
           <h2  class="italic text-3xl pb-2">Winter's Tale <span class="text-lg">by William Shakespeare</span></h2>
           ...
           <h2  class="font-bold text-3xl uppercase pt-3 text-center tracking-tighter">Co-Properties Master & Run Crew</h2>
           <h2  class="italic text-3xl pb-2 ">Silent Sky <span class="text-lg">by Lauren Gunderson</span></h2>
