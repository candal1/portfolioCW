<template>
    <div class="bg-orange-100 flex flex-col items-center overflow-hidden">
        <div class="grid py-20 items-center max-w-xl px-3 md:px-0">

           <img class="max-w-sm md:max-w-lg m-auto pt-10" src="..\assets\experience\mix factory one.jpg" alt="mix one studio"> 
           ...
           <img class="max-w-sm md:max-w-lg m-auto pt-10" src="..\assets\experience\26242736452_7c01c61709_k.jpg" alt="Winter's Tale stage scene"> 
           ...
           <img class="max-w-sm md:max-w-lg m-auto pt-10" src="..\assets\experience\31097085625_60132efd33_k.jpg" alt="Silent Sky stage"> 
